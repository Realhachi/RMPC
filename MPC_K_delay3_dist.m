...
%         e{k+1} = y{k}-c{k+1};
    ...
    LMI1 = [1       z{k}'       z{k-1}'     z{k-2}'     z{k-3}';
            z{k}    Qvj         zeros(3,3)  zeros(3,3)  zeros(3,3);
            z{k-1}  zeros(3,3)  W           zeros(3,3)  zeros(3,3);
            z{k-2}  zeros(3,3)  zeros(3,3)  W           zeros(3,3);
            z{k-3}  zeros(3,3)  zeros(3,3)  zeros(3,3)  W];   %/tao = 3 
...
if 1
figure
plot(x_rec(1,:),'g:','linewidth',1);
% plot(z_rec(1,:),'linewidth',1);
hold on
plot(x_rec(2,:),'g:','linewidth',1);
...
hold on 
plot(y_rec,'g:','linewidth',1);
xlabel('step')
ylabel('Output-Y')
legend('setpoint','statefeedback');

figure
plot(e_rec,'g:','linewidth',1);
xlabel('t/sampling')
ylabel('e(k)')
end
